      ...
      <div class="contenido">
        <div class="imagenes">
          ...
          <img
            ...
            width="100px"
          /><br />
          <span v-if="!$v.avatar.maxLength" class="error"
          >No se aceptan mas de 4 imágenes</span
          >
          <span v-if="$v.avatar.minLength" class="error"
          >Se necesita al menos una imagen</span
          >
        </div>
        <div>
